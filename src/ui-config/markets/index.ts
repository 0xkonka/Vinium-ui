...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_goerli]: {
    ...
    aTokenPrefix: 'viniGoerli',
    enabledFeatures: {
      // liquiditySwap: true,
      incentives: true,
    },
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x8FC2aA21e1963CE9C12F07fc27AFe7681Dc3969b'.toLowerCase(),
      LENDING_POOL: '0xb4705bb618fa64EEff3009d68A5696bc1Bda0E53',
      WETH_GATEWAY: '0xe2ebf2D930D0Bf680A7167bAaF623e9B312E6a06',
      VINIUM_OFT: '0x2f058f16223d0c74a1A2e6a9a47ba9c78f8776b8',
      VINIUM_LP: '0xa8e21cbe7c32cb2131a1a25c56042e2dd4f1b1ce',
      MULTIFEE_DISTRIBUTION: '0x2134E090f1172383eEcCd77B2d63f32e689b9a82',
      INCENTIVES_CONTROLLER: '0x283eB941249d80ABCFdB3e244BFAabd4c8C893fa',
      LEVERAGER: '0xaFEC67611d2EAD0d86BF343e7e0206e4Aad7F923',
      SDAI: '0xd8134205b0328f5676aaefb3b2a0dc15f4029d8c',
      MULTICALL: '0xf7Bb9EFeABd7129fE9E77D234DFB33Aa12b2f851',
      //SWAP_COLLATERAL_ADAPTER: '0x2EcF2a2e74B19Aab2a62312167aFF4B78E93B6C5',
    },
  },
} as const;
