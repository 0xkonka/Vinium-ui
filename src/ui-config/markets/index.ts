...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_goerli]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x7a6Aaf62a3112a928598101fAC0bFB9B03D9Ab11'.toLowerCase(),
      LENDING_POOL: '0xB403c5491CFf4746591CD39196AB6dd167366e79',
      WETH_GATEWAY: '0x842678f9410D97bB062B1fA12d87027d4095b7E3',
      //SWAP_COLLATERAL_ADAPTER: '0x2EcF2a2e74B19Aab2a62312167aFF4B78E93B6C5',
    },
  },
} as const;
