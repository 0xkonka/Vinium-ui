...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_goerli]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x253aAaB984f1E56D0D04DC067Bb73C5BAeC214c7'.toLowerCase(),
      LENDING_POOL: '0x51684FA42df6A553aaE41e6F79389cf90ba4DA80',
      WETH_GATEWAY: '0x6D1D7068703203A05fB5ef9056fe8B6077482736',
      MULTIFEE_DISTRIBUTION: '0xEE280750B1D883EB84e29956a2a9814f70FA7699',
      INCENTIVES_CONTROLLER: '0xCc8978D7f3F7B534472B3c7cdEF37294ACa16966',
      VINIUM_OFT: '0xFa98854f0DE9E8Bd35742C91468108b04E0429dB',
