...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_goerli]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x994b94DA91fed0a0f23468AFbc5A5fB09B9D94E6'.toLowerCase(),
      LENDING_POOL: '0x1B030505a7cD90D773393CD71C4Abf0a7259b36b',
      WETH_GATEWAY: '0xfF81FCe9695E19A24a4f96353A3285F6cfD804da',
      //SWAP_COLLATERAL_ADAPTER: '0x2EcF2a2e74B19Aab2a62312167aFF4B78E93B6C5',
    },
  },
} as const;
