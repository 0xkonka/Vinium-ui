...
interface MultiFeeDistributionInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "exitDelegatee",
    values: [string]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "publicExit",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "publicExitAreSet",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "rewardLookback",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "teamRewardFee",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "teamRewardVault",
    values?: undefined
  ): string;
  encodeFunctionData(
