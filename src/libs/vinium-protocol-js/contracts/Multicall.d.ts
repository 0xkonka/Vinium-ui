...
export class Multicall extends Contract {
  ...
  functions: {
    ...
    'aggregate(tuple[])'(calls: { target: string; callData: BytesLike }[], overrides?: Overrides): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    'aggregate(tuple[])'(calls: { target: string; callData: BytesLike }[], overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    aggregate(calls: { target: string; callData: BytesLike }[], overrides?: Overrides): Promise<PopulatedTransaction>;

    'aggregate(tuple[])'(calls: { target: string; callData: BytesLike }[], overrides?: Overrides): Promise<PopulatedTransaction>;
